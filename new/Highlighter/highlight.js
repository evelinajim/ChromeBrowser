...
// query not inside of a tag. The first argument is the query in parentheses: 
//      (qry) - the parentheses creates a 'grouping' that allows us to reference the match
// along with a negative lookahead to make sure the query does not appear within a tag.
// ?! - this is a negative lookahead (we will not count matches that the subsequent pattern
...
// then we do not want this to match (because the match would occur inside of a tag, e.g.
// <p id = 'qry'>
// 
